...
<!--********************** Contenido *****************************************-->
            ...
            <section class="col-lg-8 connectedSortable">
                ...
                <div class="box-header with-border">
                  <h3 class="box-title">Formulario Ciudadela </h3>
                </div><!-- /.box-header -->
                <!-- form start -->
            <form role="form" action="colectaDatos.php" method="post">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Ciudadela:</label>
                      <input type="text" class="form-control" name="Ciudadela" id="Ciudadela" placeholder="Ciudadela" required>
                    </div>
                  </div><!-- /.box-body -->
                  <input type="hidden" name="dato" value="4">
