    ...
    $(document).ready(function(){
      $("#Canton").change(function () {
           $("#Canton option:selected").each(function () {
            Canton = $(this).val();
            $.post("Selects/select_cargo.php", { Canton: Canton }, function(data){
                $("#Parroquia").html(data);
            });            
        });
      })
    ...
    $(document).ready(function(){
      $("#Parroquia").change(function () {
           $("#Parroquia option:selected").each(function () {
            Parroquia = $(this).val();
            $.post("Selects/select_cargo.php", { Parroquia: Parroquia }, function(data){
                $("#Ciudadela").html(data);
            });            
        });
      })
...
<!--********************** Contenido *****************************************-->
            ...
            <section class="col-lg-8 connectedSortable">
                ...
                <div class="box-header with-border">
                  <h3 class="box-title">Formulario Manzana </h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                  ...
                  <div class="box-body">            
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <select name="Ciudadela" id="Ciudadela" class="form-control" required>
                     <option value="">Seleccione una opcion...</option>
                      </select>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="Manzana" name="Manzana" placeholder="Manzana" required>
                    </div>
                  </div><!-- /.box-body -->
                  <input type="hidden" name="dato" value="5">
