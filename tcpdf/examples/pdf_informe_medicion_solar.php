...
<tr>
<td width="100%">
				<b>Manzana N°: </b>'.$manzana.'<br>
				<b>Solar N°: </b>'.$solar.'<br>
				<b>'.$gtt.':</b>  '.$Parroquia.' <br><br>
				<b>Superficie:</b> '.$Superficie.' m<sup>2</sub>
</td>
</tr>
</table>
<br><br>
<table width="100%" border="0">
<tr>
<td width="100%"><b>CODIGO CATASTRAL:</b> '.$clave.'</td>

</tr>

<tr>
<td width="100%"><b>SECTOR:</b> '.$sector.'</td>
...
<td width="68%">'.$lnd.'&nbsp;</td>
<td width="7%"><b>&nbsp;CON</b></td>
<td width="15%"> &nbsp;'.$ln.' <b>ML</b></td>
