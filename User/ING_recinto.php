...
<!--********************** Contenido *****************************************-->
            ...
            <form role="form" action="colectaDatos.php" method="post">
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label for="exampleInputEmail1">Recinto:</label>
                      <input type="text" class="form-control" name="Recinto" id="Recinto" placeholder="Recinto" required>
                    </div>
                  </div><!-- /.box-body -->
                  <input type="hidden" name="dato" value="6">
