...
<!--********************** Contenido *****************************************-->
            ...
            <section class="col-lg-8 connectedSortable">
                ...
                <div class="box-header with-border">
                  <h3 class="box-title">Formulario Parroquia </h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                      ...
                      <select name="tipoparroquia" class="form-control" required>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control"  name="Parroquia" id="Parroquia" placeholder="Parroquia" required>
                    </div>
                  </div><!-- /.box-body -->
                  <input type="hidden" name="dato" value="3">
